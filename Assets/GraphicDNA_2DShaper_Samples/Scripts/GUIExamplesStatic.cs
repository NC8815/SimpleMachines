...
public class GUIExamplesStatic : MonoBehaviour
{
    ...
    {        
        ...
        Drawing2D.DrawText("Lines & Arrows", mRectangleX + 5, mRectangleY + 5, 18, Color.white);                
    ...
    private void DrawRectangles()
    {
        ...
        Drawing2D.DrawRect(new Rect(mRectangleX, mRectangleY, mRectangleWidth, mRectangleHeight));
        Drawing2D.DrawText("Rects & Quads", mRectangleX + 5, mRectangleY + 5, 18, Color.white);
        float x = 15 - mSampleWidth;
    ...
    private void DrawCircles()
    {
        mRectangleY += mRectangleHeight + 20;
        Drawing2D.DrawRect(new Rect(mRectangleX, mRectangleY, mRectangleWidth, mRectangleHeight));
        Drawing2D.DrawText("Circles", mRectangleX + 5, mRectangleY + 5, 18, Color.white);
        float x = 15 - mSampleWidth;
    ...
    private void DrawArcs()
    {
        mRectangleY += mRectangleHeight + 20;
        Drawing2D.DrawRect(new Rect(mRectangleX, mRectangleY, mRectangleWidth, mRectangleHeight));
        Drawing2D.DrawText("Arcs", mRectangleX + 5, mRectangleY + 5, 18, Color.white);
        float x = 15 - mSampleWidth;
        float y = mRectangleY + 50;
        float radius = mRectangleHeight - 60;
    ...
    private void DrawTriangles()
    {
        mRectangleY += mRectangleHeight + 20;
        Drawing2D.DrawRect(new Rect(mRectangleX, mRectangleY, mRectangleWidth, mRectangleHeight));
        Drawing2D.DrawText("Triangles", mRectangleX + 5, mRectangleY + 5, 18, Color.white);
        float x = 15 - mSampleWidth;
        float y = mRectangleY + 50;
        x += mSampleWidth + 50;
    ...
    private void DrawPolygons()
    {
        mRectangleY += mRectangleHeight + 20;
        Drawing2D.DrawRect(new Rect(mRectangleX, mRectangleY, mRectangleWidth, mRectangleHeight));
        Drawing2D.DrawText("Polygons", mRectangleX + 5, mRectangleY + 5, 18, Color.white);
        float x = 15 - mSampleWidth;
        float y = mRectangleY + 50;
        float radius = mRectangleHeight - 60;
    ...
    private void DrawCompound()
    {
        ...
        mRectangleY += mRectangleHeight + 20;
        Drawing2D.DrawRect(new Rect(mRectangleX, mRectangleY, mRectangleWidth, mRectangleHeight));
        Drawing2D.DrawText("Other", mRectangleX + 5, mRectangleY + 5, 18, Color.white);
        float x = 15 - mSampleWidth;
        float y = mRectangleY + 35;
        float height = mRectangleHeight - 55;
        ...
        Drawing2D.DrawText("75%", (x) + ((mSampleWidth / 2) - radius - 15), y - 9, 18, Color.white);
        y -= 5;
        ...
        Drawing2D.DrawText("Time", x + 220, y + 20, 11, ToColor(240, 240, 240));
        Drawing2D.DrawText("Value", x + 5, y - 25, 11, ToColor(240, 240, 240));
