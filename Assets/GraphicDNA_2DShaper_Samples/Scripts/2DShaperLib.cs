...
namespace GraphicDNA
{
    public class Drawing2D
    {
        ...
        //private static Texture2D mDefaultPixelTexture;
        ///// <summary>
        ///// Default pixel texture used for filling solid shapes
        ///// </summary>
        ...
        //        if (!mDefaultPixelTexture)
        //        {
        //            mDefaultPixelTexture = new Texture2D(1, 1);
        //            mDefaultPixelTexture.SetPixel(0, 0, Color.white);
        //            mDefaultPixelTexture.Apply();
        //        }

        //        return mDefaultPixelTexture;
        //    }
        //}
        ...
        private static Vector3 GUIPointToGLVertex(Vector2 pGUIPoint)
        {
            ...
            return new Vector3(pt.x / Screen.width, pt.y / Screen.height, 0);
        }
        /// <summary>
        ...
        public static Rect GetWorldRect(RectTransform pTransform)
        {
            ...
            Vector2 mTLCorner = new Vector2(worldCorners[1].x, Screen.height - worldCorners[1].y);
        ...
        /// <param name="pTilingMultiplier">Tiling multiplier or null for default tiling (1, 1)</param>
        public static void FillQuads(Vector2[] pVertices, Color color, Texture2D pOverrideTexture = null, Vector2? pTilingMultiplier = null)
        {
            // If we are currently in the Repaint event, begin to draw a clip of the size of 
            // previously reserved rectangle, and push the current matrix for drawing.
            GL.PushMatrix();
        ...
        private static void DrawFullScreenQuad(Rect previewRect)
        {
        ...
        public static void DrawText(string pText, Vector2 pPos, int pFontSize, Color pColor)
        {
            DrawText(pText, pPos.x, pPos.y, pFontSize, pColor);
        }
        /// <summary>
        /// Draws text
        /// </summary>
        ...
        /// <param name="pFontSize">Font size</param>
        /// <param name="pColor">Color of the text</param>
        public static void DrawText(string pText, float pX, float pY, int pFontSize, Color pColor)
        {
