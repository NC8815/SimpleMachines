...
public class GUIExamplesDynamic : MonoBehaviour
{
    ...
    private void DrawChart()
    {
        ...
        Drawing2D.DrawText("Time", mChartX + mChartWidth, mChartY + mChartHeight - 10, 11, ToColor(240, 240, 240));
        Drawing2D.DrawText("Value", mChartX + 5, mChartY - 25, 11, ToColor(240, 240, 240));
    ...
    {
        mPictureAngle1 += Time.deltaTime * 5f;
        mPictureAngle2 -= Time.deltaTime;
